...
class ItemPopUp extends Component {
    ...
    _onPressAddToCart(iced_hot, sugar, shots) {
        if (this.state.count > 0) {
                        ...
                        <ModalContent >
                            <View style={styles.dishes}>
                                ...
                                <View style={styles.total_quantity}>
                                    <TouchableOpacity>
                                        <Icon name='plus-circle' size={20} style={styles.btnPlus} onPress={this.plus.bind(this)} />
                                    </TouchableOpacity>
                                    <Text >{this.state.count}</Text>
                                    <TouchableOpacity>
                                        <Icon name='minus-circle' size={20} style={styles.btnPlus} onPress={this.minus.bind(this)} />
                                    </TouchableOpacity>
                                </View>
                            </View>
                            ...
                            <TouchableOpacity style={styles.btn_addCart} onPress={() => this._onPressAddToCart(this.state.btn_ice, this.state.btn_sugar, this.state.btn_shots)}>
